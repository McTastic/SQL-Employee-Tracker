...
const promptDepartment =()=>{
    ...
    .then((data) =>{
        db.query(`INSERT INTO department SET ?`, {name:data.addDepartment}, (err,result) =>{
            if(err){
                console.log(err);
            }
            viewDepartments();
...
const promptRole = () => {
    ...
    .then((data)=>{
        ...
        db.query(` INSERT INTO role SET ?`, {title:data.addRole, salary:data.roleSalary, department_id:departmentID}, (err,result) =>{
            if(err){
                console.log(err);
            }
            viewRoles();
...
const promptAddEmployee = () =>{
    ...
    .then((data)=>{
        ...
        db.query(`INSERT INTO employee SET ?`, {first_name:data.employeeFirst, last_name:data.employeeLast, role_id:roleID, manager_id:managerID}, (err,result) =>{
            if(err){
                console.log(err);
            }
            viewEmployees();
